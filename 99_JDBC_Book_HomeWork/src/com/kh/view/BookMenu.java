...
public class BookMenu {
    ...
    private void addBook() {
        ...
        if (isBook) {
            System.out.println(bc.addBook(new Book(bNo, title, author, publisher, price, description)));
        } else {
            ...
            System.out.println(bc.addBook(new Magazine(bNo, title, author, publisher, price, description, year, month)));
        }
    }
