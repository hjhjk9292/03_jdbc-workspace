...
/*
 * * VO(Value Object) 													  ㅡ 그릇과 같은 클래스
 * 	 한 명의 회원(DB 테이블의 한 행의 데이터들)에 대한 데이터들을 기록할 수 있는 저장용 객체 ㅡ 차은우 한 명 담을 그릇, 관리자 담을 그릇이라고 생각...
 * 
 */
public class Member {
	
	// 필드부
	// 필드는 기본적으로 DB컬럼명과 유사하게 작업! ㅡ DB컬럼 보고 그대로... 그릇처럼 만들기
	private int userNo;
